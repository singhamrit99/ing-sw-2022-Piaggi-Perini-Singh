...
The project's goal is to implement [Eriantys](https://www.craniocreations.it/prodotto/eriantys/) board game. The project covers all rules of the game, including 4 player game and expert mode with Character cards, and enables to play in two ways: command line interface(CLI) or graphical user interface(GUI).
...
* [Simple UML](https://github.com/martinopiaggi/ing-sw-2022-Piaggi-Perini-Singh/tree/master/deliverables/UML/Initial%20UML):
  contains only the definition of the various classes, omitting minor details
